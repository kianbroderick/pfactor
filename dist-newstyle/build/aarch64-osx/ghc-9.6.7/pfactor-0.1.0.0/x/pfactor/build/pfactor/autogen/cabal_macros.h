...
/* package pfactor-0.1.0.0 */
#ifndef VERSION_pfactor
#define VERSION_pfactor "0.1.0.0"
#endif /* VERSION_pfactor */
#ifndef MIN_VERSION_pfactor
#define MIN_VERSION_pfactor(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_pfactor */
...
#define CURRENT_COMPONENT_ID "pfactor-0.1.0.0-inplace-pfactor"
